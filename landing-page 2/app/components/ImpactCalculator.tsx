...
export default function ImpactCalculator() {
  ...
  const handleGetFullReport = () => {
    // Redirect to admin portal for charger owners
    window.location.href = 'http://admin.nerava.network.s3-website-us-east-1.amazonaws.com?src=landing&cta=impact-calculator'
  }
