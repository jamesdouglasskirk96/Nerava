...
resource "aws_ecr_repository" "driver" {
  ...
  tags = {
    Name = "${var.project_name}-driver-ecr"
  }
}

resource "aws_ecr_repository" "merchant" {
  ...
  tags = {
    Name = "${var.project_name}-merchant-ecr"
  }
}
...
resource "aws_ecr_repository" "admin" {
  ...
  tags = {
    Name = "${var.project_name}-admin-ecr"
  }
}
...
resource "aws_ecr_repository" "landing" {
  ...
  tags = {
    Name = "${var.project_name}-landing-ecr"
  }
}
...
resource "aws_ecr_lifecycle_policy" "driver" {
  repository = aws_ecr_repository.driver.name
...
resource "aws_ecr_lifecycle_policy" "merchant" {
  repository = aws_ecr_repository.merchant.name
