...
# Priority: settings.GOOGLE_PLACES_API_KEY > os.getenv > hardcoded fallback
# Note: Use getattr since GOOGLE_PLACES_API_KEY may not be defined in all config modules
