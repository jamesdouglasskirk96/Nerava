...
class ExclusiveSession(Base):
    ...
    # Force close tracking (admin override)
    force_close_reason = Column(String, nullable=True)
    force_closed_by = Column(Integer, ForeignKey("users.id"), nullable=True)  # Admin user ID
