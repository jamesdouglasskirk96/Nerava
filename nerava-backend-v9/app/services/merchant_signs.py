...
def generate_merchant_sign_pdf(merchant: DomainMerchant, qr_url: str) -> bytes:
    ...
    if not REPORTLAB_AVAILABLE:
        raise ValueError("reportlab is required for PDF generation. Install with: pip install reportlab")
    if not QRCODE_AVAILABLE:
        raise ValueError("qrcode is required for QR code generation. Install with: pip install qrcode[pil]")
