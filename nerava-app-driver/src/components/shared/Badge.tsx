...
export function Badge({ children, variant = 'default', className = '' }: BadgeProps) {
  ...
  const variantClasses = {
    ...
    sponsored: 'px-[13px] py-[7px] bg-white/90 text-[#656A6B] border border-[#E4E6EB]',
    exclusive: 'px-[11px] py-[6px] text-[#A65F00] border border-[#D08700]/30',
    'walk-time': 'px-3 py-1.5 bg-facebook-blue text-white',
    'walk-time-secondary': 'px-[10px] py-[5px] bg-facebook-blue/10 text-facebook-blue',
  }
