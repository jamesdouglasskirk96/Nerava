...
export const MOCK_MERCHANTS: MerchantSummary[] = [
  {
    ...
    photo_url: undefined, // Will use category logo fallback
    icon_url: undefined,
...
export const MOCK_MERCHANT_DETAILS: Record<string, MerchantDetailsResponse> = {
  mock_asadas_grill_001: {
    merchant: {
      ...
      photo_url: undefined,
      address: '123 Main St, Austin, TX 78753',
      rating: 4.5,
      price_level: 2,
    },
    moment: {
    ...
    perk: {
      ...
      badge: 'Exclusive',
      description: 'Get 15% off your meal during charging hours. Show your pass at checkout to redeem.',
    },
    wallet: {
      can_add: true,
      state: 'INACTIVE',
