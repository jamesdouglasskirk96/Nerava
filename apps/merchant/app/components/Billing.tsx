...
import { Check, Loader2, ExternalLink, FileText } from 'lucide-react';
import { createSubscription, getSubscription, cancelSubscription, getBillingPortalUrl, getInvoices, type Invoice } from '../services/api';
  ...
  useEffect(() => {
    ...
    getSubscription()
      .then((data) => {
        ...
        // Load invoices if there's a subscription
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-neutral-500 mt-1">Choose the plan that fits your business</p>
      </div>
      ...
      {(invoices.length > 0 || invoicesLoading) && (
        <div className="mt-10">
          <h2 className="text-xl font-semibold text-neutral-900 mb-4">Invoice History</h2>
          {invoicesLoading ? (
