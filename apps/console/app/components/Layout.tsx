    ...
    <div className="flex h-screen bg-white">
      ...
      <aside className="w-64 bg-[#F7F8FA] border-r border-[#E4E6EB] flex flex-col">
        ...
        <div className="p-6 border-b border-[#E4E6EB]">
          ...
          <div className="text-xs text-[#65676B] mt-2">Campaign Console</div>
        </div>
        ...
        <div className="p-4 border-t border-[#E4E6EB]">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 rounded text-sm font-medium text-[#65676B] hover:bg-white/50 hover:text-[#050505] transition-colors w-full"
          >
