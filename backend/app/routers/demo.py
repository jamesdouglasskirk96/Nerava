...
from app.models_demo import DemoState, DemoSeedLog, ApiKey
from app.schemas.demo import (
    DemoScenarioRequest, DemoScenarioResponse, DemoStateResponse,
    DemoSeedResponse, DemoTourResponse, DemoTourStep
)
...
def _check_demo_mode():
    ...
    if not is_demo():
        raise HTTPException(
            status_code=403, 
            detail={"error": "demo_disabled", "message": "Demo mode is disabled"}
        )
...
async def enable_all_flags(
    ...
    try:
        ...
        feature_flags = [
            "feature_merchant_intel", "feature_behavior_cloud", "feature_autonomous_reward_routing",
            "feature_city_marketplace", "feature_multimodal", "feature_merchant_credits",
            "feature_charge_verify_api", "feature_energy_wallet_ext", "feature_merchant_utility_coops",
            "feature_whitelabel_sdk", "feature_energy_rep", "feature_carbon_micro_offsets",
            "feature_fleet_workplace", "feature_smart_home_iot", "feature_contextual_commerce",
            "feature_energy_events", "feature_uap_partnerships", "feature_ai_reward_opt",
            "feature_esg_finance_gateway", "feature_ai_growth_automation"
        ]
...
async def set_scenario(
    ...
    if value not in valid_values.get(key, set()):
        raise HTTPException(status_code=400, detail=f"Invalid value for {key}. Must be one of: {valid_values.get(key)}")
...
async def run_investor_tour(
    ...
    try:
        ...
        artifacts = {
            ...
            "finance_offers": {
                "apr_delta_bps": -50,
                "eligibility": "High energy reputation"
            },
            "coop_pools": {
                "merchants": 5,
                "utility_partners": 2,
    ...
    try:
        ...
        export_data = {
            ...
            "merchant_intel": {
                ...
                "promos": [{"type": "coffee_discount", "value": "$2 off", "conditions": "grid_load < 70%"}]
            },
            "ai_rewards": {
                "suggestions": [
            ...
            "events": [
                ...
                {"type": "reward_redemption", "user": "u_follower1", "merchant": "Coffee Corner", "value": "$2.00"}
            ]
        }
